...
MesaUtilLib_SRC  = \
	...
	$(MESA_VER)/src/util/mesa-blake3.c \
	...
	$(MESA_VER)/src/util/texcompress_astc_luts.cpp \
	$(MESA_VER)/src/util/texcompress_astc_luts_wrap.cpp \
	$(MESA_VER)/src/util/u_atomic.c \
	$(MESA_VER)/src/util/u_call_once.c \
	$(MESA_VER)/src/util/u_dl.c \
	$(MESA_VER)/src/util/u_dynarray.c \
	...
	$(MESA_VER)/src/util/vl_zscan_data.c \
	...
	$(MESA_VER)/src/util/thread_sched.c \
...
MesaUtilLib_SRC += \
  $(MESA_VER)/src/util/blake3/blake3.c \
  $(MESA_VER)/src/util/blake3/blake3_dispatch.c \
  $(MESA_VER)/src/util/blake3/blake3_portable.c
...
MesaLib_SRC  = \
	...
	$(MESA_VER)/src/compiler/spirv/vtn_debug.c \
...
MesaLib_SRC += \
	...
	$(MESA_VER)/src/mesa/state_tracker/st_nir_lower_fog.c \
	$(MESA_VER)/src/mesa/state_tracker/st_nir_lower_position_invariant.c \
	$(MESA_VER)/src/mesa/state_tracker/st_nir_lower_tex_src_plane.c \
	$(MESA_VER)/src/mesa/state_tracker/st_nir_unlower_io_to_vars.c \
...
MesaLib_SRC += \
	...
	$(MESA_VER)/src/mesa/main/ff_fragment_shader.c \
	...
	$(MESA_VER)/src/mesa/main/glthread_pixels.c \
	...
	$(MESA_VER)/src/mesa/main/spirv_capabilities.c \
...
MesaLib_SRC += \
	$(MESA_VER)/src/compiler/glsl_types.c \
...
MesaLib_SRC += \
	...
	$(MESA_VER)/src/compiler/glsl/gl_nir_lower_blend_equation_advanced.c \
	$(MESA_VER)/src/compiler/glsl/gl_nir_lower_named_interface_blocks.c \
	$(MESA_VER)/src/compiler/glsl/gl_nir_link_atomics.c \
	$(MESA_VER)/src/compiler/glsl/gl_nir_link_functions.c \
	...
	$(MESA_VER)/src/compiler/glsl/gl_nir_link_interface_blocks.c \
	$(MESA_VER)/src/compiler/glsl/gl_nir_opt_dead_builtin_varyings.c \
	$(MESA_VER)/src/compiler/glsl/gl_nir_detect_function_recursion.c \
	$(MESA_VER)/src/compiler/glsl/gl_nir_lower_discard_flow.c \
...
MesaLib_SRC += \
	...
	$(MESA_VER)/src/compiler/nir/nir_fixup_is_exported.c \
	$(MESA_VER)/src/compiler/nir/nir_format_convert.c \
	$(MESA_VER)/src/compiler/nir/nir_from_ssa.c \
	$(MESA_VER)/src/compiler/nir/nir_functions.c \
	$(MESA_VER)/src/compiler/nir/nir_gather_info.c \
	$(MESA_VER)/src/compiler/nir/nir_gather_types.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_legacy.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_lower_frag_coord_to_pixel_coord.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_lower_image_atomics_to_global.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_lower_reg_intrinsics_to_ssa.c \
	$(MESA_VER)/src/compiler/nir/nir_lower_readonly_images_to_tex.c \
	$(MESA_VER)/src/compiler/nir/nir_lower_returns.c \
	$(MESA_VER)/src/compiler/nir/nir_lower_robust_access.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_lower_tess_coord_z.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_lower_vec_to_regs.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_move_output_stores_to_end.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_opt_loop.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_opt_reassociate_bfi.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_opt_vectorize_io.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_remove_tex_shadow.c \
	...
	$(MESA_VER)/src/compiler/nir/nir_trivialize_registers.c \
	$(MESA_VER)/src/compiler/nir/nir_validate.c \
	$(MESA_VER)/src/compiler/nir/nir_worklist.c \
	$(MESA_VER)/src/compiler/nir/nir_opt_varyings.c \
	$(MESA_VER)/src/compiler/nir/nir_use_dominance.c
MesaLib_SRC += \
...
MesaGalliumAuxLib_SRC = \
	...
	$(MESA_VER)/src/gallium/auxiliary/draw/draw_pt_mesh_pipeline.c \
	...
	$(MESA_VER)/src/gallium/auxiliary/draw/draw_mesh.c \
	$(MESA_VER)/src/gallium/auxiliary/draw/draw_mesh_prim.c \
	...
	$(MESA_VER)/src/gallium/auxiliary/driver_trace/tr_video.c \
...
MesaGalliumAuxLibSimd_SRC = \
  ...
  $(MESA_VER)/src/gallium/auxiliary/gallivm/lp_bld_init_common.c \
  ...
  $(MESA_VER)/src/gallium/auxiliary/gallivm/lp_bld_passmgr.c \
  ...
  $(MESA_VER)/src/gallium/auxiliary/gallivm/lp_bld_jit_sample.c \
...
MesaGalliumLLVMPipe_SRC += \
  ...
  $(MESA_VER)/src/gallium/drivers/llvmpipe/lp_texture_handle.c \
