...
HRESULT STDMETHODCALLTYPE Direct3DDevice8::GetTexture(DWORD Stage, IDirect3DBaseTexture8 **ppTexture)
{
	...
	*ppTexture = nullptr;
	...
	if (BaseTextureInterface != nullptr)
	{
		...
		{
		case D3DRTYPE_TEXTURE:
			BaseTextureInterface->QueryInterface(IID_IDirect3DTexture9, (void**)&TextureInterface /*IID_PPV_ARGS(&TextureInterface)*/);
			*ppTexture = ProxyAddressLookupTable->FindAddress<Direct3DTexture8>(TextureInterface);
			break;
		case D3DRTYPE_VOLUMETEXTURE:
			BaseTextureInterface->QueryInterface(IID_IDirect3DVolumeTexture9, (void**)&VolumeTextureInterface /*IID_PPV_ARGS(&VolumeTextureInterface)*/);
			*ppTexture = ProxyAddressLookupTable->FindAddress<Direct3DVolumeTexture8>(VolumeTextureInterface);
			break;
		case D3DRTYPE_CUBETEXTURE:
			BaseTextureInterface->QueryInterface(IID_IDirect3DCubeTexture9, (void**)CubeTextureInterface /*IID_PPV_ARGS(&CubeTextureInterface)*/);
