...
GENERATE_FILES = \
	...
	$(MESA_VER)/src/mapi/shared-glapi/shared_glapi_mapi_tmp.h
...
$(MESA_VER)/src/mapi/shared-glapi/shared_glapi_mapi_tmp.h:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) ../../mapi_abi.py gl_and_es_API.xml --printer shared-glapi > ../../shared-glapi/$(notdir $@)
...
$(MESA_VER)/src/mesa/main/unmarshal_table.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) unmarshal_table_c.py gl_and_es_API.xml $(MESA_SIZEOF_PTR) > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated0.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) marshal_generated_c.py gl_and_es_API.xml 0 8 $(MESA_SIZEOF_PTR) > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated1.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) marshal_generated_c.py gl_and_es_API.xml 1 8 $(MESA_SIZEOF_PTR) > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated2.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) marshal_generated_c.py gl_and_es_API.xml 2 8 $(MESA_SIZEOF_PTR) > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated3.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) marshal_generated_c.py gl_and_es_API.xml 3 8 $(MESA_SIZEOF_PTR) > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated4.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) marshal_generated_c.py gl_and_es_API.xml 4 8 $(MESA_SIZEOF_PTR) > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated5.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) marshal_generated_c.py gl_and_es_API.xml 5 8 $(MESA_SIZEOF_PTR) > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated6.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) marshal_generated_c.py gl_and_es_API.xml 6 8 $(MESA_SIZEOF_PTR) > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated7.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) marshal_generated_c.py gl_and_es_API.xml 7 8 $(MESA_SIZEOF_PTR) > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated.h:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) marshal_generated_h.py gl_and_es_API.xml $(MESA_SIZEOF_PTR) > ../../../mesa/main/$(notdir $@)
