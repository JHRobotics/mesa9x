...
$(MESA_VER)/src/mesa/main/unmarshal_table.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) gl_unmarshal_table.py gl_and_es_API.xml > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated0.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) gl_marshal.py gl_and_es_API.xml 0 8 > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated1.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) gl_marshal.py gl_and_es_API.xml 1 8 > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated2.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) gl_marshal.py gl_and_es_API.xml 2 8 > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated3.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) gl_marshal.py gl_and_es_API.xml 3 8 > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated4.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) gl_marshal.py gl_and_es_API.xml 4 8 > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated5.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) gl_marshal.py gl_and_es_API.xml 5 8 > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated6.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) gl_marshal.py gl_and_es_API.xml 6 8 > ../../../mesa/main/$(notdir $@)

$(MESA_VER)/src/mesa/main/marshal_generated7.c:
	cd $(MESA_VER)/src/mapi/glapi/gen && $(PYTHON) gl_marshal.py gl_and_es_API.xml 7 8 > ../../../mesa/main/$(notdir $@)
...
$(MESA_VER)/src/gallium/auxiliary/driver_trace/tr_util.c:
	cd $(dir $@) && $(PYTHON) enums2names.py ../../include/pipe/p_defines.h -C $(notdir $@) -H tr_util.h -I tr_util.h
