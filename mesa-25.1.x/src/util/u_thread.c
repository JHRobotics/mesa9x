...
{
   int ret = thrd_error;
#if defined(HAVE_PTHREAD) && !(DETECT_OS_FUCHIA || defined(WIN9X))
...
#if DETECT_OS_LINUX || DETECT_OS_CYGWIN || DETECT_OS_SOLARIS || defined(__GLIBC__) || DETECT_OS_MANAGARM || DETECT_OS_FUCHSIA || defined(WIN9X)
